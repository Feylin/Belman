...
//        {
//            String sql = "INSERT INTO StockItem(id, chargeNo, length, stockQuantity, coilTypeId, sleeveId) VALUES (?,?,?,?,?,?)";
//            PreparedStatement ps = con.prepareStatement(sql);
//            ps.setInt(1, item.getId());
//            ps.setString(2, item.getChargeNo());
//            ps.setDouble(3, item.getLength());
//            ps.setDouble(4, item.getStockQuantity());
//            ps.setDouble(5, item.getCoilTypeId());
//            ps.setInt(6, item.getSleeveId());
//
//
